...
export const createPermissionSuccess = createAction('[Permissions] Create Success', props<{ item: Permission }>());
...
export const updatePermissionSuccess = createAction('[Permissions] Update Success', props<{ item: Permission }>());
...
export const deletePermissionSuccess = createAction('[Permissions] Delete Success', props<{ id: number }>());
